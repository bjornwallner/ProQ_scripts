...
#print "/local/www/services/ProQ2/apps/blast-2.2.18_x86_64/blastall -i $query_file -d $data_dir/dataset -p blastp -F F -g F -o ${temp_file}foob.txt\n";
#`/local/www/services/ProQ2/apps/blast-2.2.18_x86_64/bin/blastall -i $query_file -d $data_dir/dataset -p blastp -F F -g F -o ${temp_file}foob.txt`;
