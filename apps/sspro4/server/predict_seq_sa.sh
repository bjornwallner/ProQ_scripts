...
/proj/wallner/users/x_bjowa/github/ProQ_scripts/apps/sspro4/server/predict_seq_sa /proj/wallner/users/x_bjowa/github/ProQ_scripts/apps/sspro4/model/accpro.model $1 $2 $3 5
